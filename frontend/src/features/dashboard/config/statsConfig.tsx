import type { StatsConfig } from '../components/StatsGrid';
...
export const createVehicleStatsConfig = (data: StatsData): StatsConfig[] => [
  {
  ...
  {
    title: "BEV Count",
    value: data.bevCount.toLocaleString(),
    icon: (
  ...
  {
    title: "PHEV Count",
    value: data.phevCount.toLocaleString(),
    icon: (
...
export const createPopulationStatsConfig = (data: StatsData): StatsConfig[] => [
  {
    title: "States",
    value: data.uniqueStates.toString(),
    icon: (
  ...
  {
    title: "Counties",
    value: data.uniqueCounties.toString(),
    icon: (
  ...
  {
    title: "Cities",
    value: data.uniqueCities.toString(),
    icon: (
  ...
  {
    title: "Makes",
    value: data.uniqueMakes.toString(),
    icon: (
